...
# vsim -gui work.integrated_design 
# Start time: 12:39:48 on May 30,2022
...
#           Attempting to use alternate WLF file "./wlft36aya7".
# ** Warning: (vsim-WLF-5001) Could not open WLF file: vsim.wlf
#           Using alternate file: ./wlft36aya7
...
force -freeze sim:/integrated_design/input_port 16#00000030 0
run
...
run
run
force -freeze sim:/integrated_design/input_port 16#000000050 0
run
force -freeze sim:/integrated_design/input_port 16#00000100 0
run
force -freeze sim:/integrated_design/input_port 16#000000300 0
run
run
run
run
