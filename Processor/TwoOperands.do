...
# vsim -gui work.integrated_design 
# Start time: 12:09:41 on May 30,2022
...
#           Attempting to use alternate WLF file "./wlftc5ykcc".
# ** Warning: (vsim-WLF-5001) Could not open WLF file: vsim.wlf
#           Using alternate file: ./wlftc5ykcc
...
run
run
force -freeze sim:/integrated_design/input_port 16#00000019 0
run
force -freeze sim:/integrated_design/input_port 16#FFFFFFFF 0
run
force -freeze sim:/integrated_design/input_port 16#FFFFF320 0
run
run
run
run
